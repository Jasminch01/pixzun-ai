...
export const Modal: React.FC<ModalProps> = ({
  ...
  modalSize = "md:w-[40rem] md:h-[25rem] mb-40", // Default size
      ...
      {isOpen && (
        <>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center">
            ...
            <dialog
              ref={modalRef}
              className={`relative z-40 rounded modal p-[1px] bg-gradient-to-r from-[#A82AD8] to-[#A82AD8] border-none shadow-none outline-none ${modalSize}`}
            >
